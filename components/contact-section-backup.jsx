    ...
    <section id="contact" className="relative py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-16 lg:grid-cols-2">
          ...
          >
            <form className="space-y-6 rounded-2xl border border-border bg-card p-8">
              ...
              <button
                type="submit"
                className="group flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground transition-all hover:shadow-lg hover:shadow-primary/25"
              >
                Send Message
                <svg
