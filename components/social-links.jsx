...
export const socialLinks = [
  { label: "GitHub", href: "https://github.com/hector-mendoza", icon: Github },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/hector-mendoza-m/", icon: Linkedin },
  {
    label: "Threads",
  ...
  { label: "Email", href: "mailto:hey@hectormendoza.me", icon: Mail },
];
